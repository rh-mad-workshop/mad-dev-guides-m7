...
* Go back to the https://developer-hub-rhdhub.%SUBDOMAIN%[Red Hat Developer Hub UI^] and click on *Deployment* in the *Overview* tab to review your deployment status in OpenShift.
